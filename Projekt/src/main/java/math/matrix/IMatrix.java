...
public interface IMatrix {
    ...
    IMatrix multiplyDouble(double multiplier);

    IMatrix nMultiplyDouble(double multiplier);

    IMatrix rotate(IVector angleVector);

    IMatrix translate(IVector translationVector);
}
